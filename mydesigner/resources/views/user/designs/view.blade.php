                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="h3">
                                    ...
                                    @switch($design->status)
                                        @case('in-progress')
                                            <form action="{{ route('user.design.request.approve', $design->id) }}" method="POST" class="float-right" onsubmit="return confirm('Are you sure you want to approve this design request?');">
                                                {{ method_field('PUT') }}
                                                {{ csrf_field() }}
                                                <button class="btn btn-md btn-outline-success">Approve Design Request</button>
                                            </form>
                                        @break
                                    @endswitch
                                </div>
